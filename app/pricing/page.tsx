...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      'Everything in Core',
      'Autonomous win-back triggers',
      'SMS campaigns',
      'Multi-POS support (Toast, Clover +)',
      'Up to 10,000 customers',
      '5,000 Yara credits / month',
      'Priority support',
    ],
    highlight: false,
  },
  {
    ...
    features: [
      'Everything in Brain',
      'Unlimited customers',
      'Unlimited POS connections',
      '15,000 Yara credits / month',
